...
import { plannedUnitCodes, summarizeAoSProgress, summarizePlan } from "./progress.ts";
import type {
  PlannerAreaOfStudy,
...
function emptyState(): PlannerState {
  return {
    ...
    selectedAos: {},
    years: [
      { label: "Year 1", slots: [{ kind: "S1", unitCodes: [] }, { kind: "S2", unitCodes: [] }] },
      { label: "Year 2", slots: [{ kind: "S1", unitCodes: [] }, { kind: "S2", unitCodes: [] }] },
    ],
  };
}
