...
export function UnitSearchDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="h-[min(72vh,640px)] grid-rows-[auto_minmax(0,1fr)_auto] gap-0 overflow-hidden p-0 sm:max-w-[720px]"
      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 border-t px-4 py-2 text-[11px] text-muted-foreground">
          ...
          <span>
            <kbd className="rounded border bg-muted px-1 py-0.5">↵</kbd> add ·{" "}
